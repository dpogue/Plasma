...
protected:
     ...
     * otherwise.
     */
    bool IGetD3DCardInfo(hsG3DDeviceRecord& record, D3DEnum_DisplayInfo* driverInfo, uint32_t* vendorID, uint32_t* deviceID, ST::string& driverString, ST::string& descString);
     ...
     */
    void IFudgeDirectXDevice(hsG3DDeviceRecord& record, D3DEnum_DisplayInfo* driverInfo, D3DEnum_RendererInfo* deviceInfo);
