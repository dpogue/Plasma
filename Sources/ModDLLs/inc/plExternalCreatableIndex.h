...
#ifndef plExternalCreatableIndex_inc
#define plExternalCreatableIndex_inc
...
public:
    ...
    enum
    {
        ...
        //EXTERN_CLASS_INDEX(MyDLLKeyedObject),
        EXTERN_CLASS_INDEX(pmDebugMgr),
        ...
        //EXTERN_CLASS_INDEX(MyDLLNonKeyedObject),
